...
Like last week, you will work on coding tasks coming from (R + Python) OR (R + advanced R).
If you only submit a .R file on canvas, we assume you want to be graded on R + advanced R.
If there is a .R file AND a python file, then you will be graded on R + Python.
...
It is extremely important to put comments in your script to show which of your code pieces belong to which task. Keep the code in order with the numbered tasks with comments like <br>
#R 1<br> 
#R 2<br>
#P1<br>
